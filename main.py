...
header_text_group = Group(scale=1, x=16, y=20)
header_text = "Next Spaceflight"
header_text_area = label.Label(FONT, text=header_text, color=0xFFFFFF)
...
countdown_text_group = Group(scale=1, x=16, y=95)
countdown_text_area = label.Label(FONT, text="\n\n\nLoading...", color=0xFFFFFF)
...
while True:
    ...
    for _ in range(num_cycles):
        ...
        countdown_text_area.text = final_formatted_str
